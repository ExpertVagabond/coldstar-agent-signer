...
export function isWireEnvelope(v) {
 ...
 */
export function wrapForAirGap(payload, type) {
...
export function wrapPolicyEnvelope(envelope) {
 ...
 * deeper in.
 */
export function unwrapFromAirGap(text) {
    let parsed;
    try {
    ...
    if (!isWireEnvelope(parsed))
        throw new Error("not an air-gap envelope (need type, version and data)");
...
export function unwrapPolicyEnvelope(text) {
...
//# sourceMappingURL=wireEnvelope.js.map